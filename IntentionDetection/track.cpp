...
Track::Track(const float& dt, const Eigen::Vector2f& target_delta, const float& x, const float& y, const float& vx, const float& vy,
...
Eigen::Vector2f Track::predict()
{
    ...
    ellipse_volume = EIGEN_PI * g_sigma * sqrt(S.determinant());
